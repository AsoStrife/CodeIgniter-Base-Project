...
<div id="page-wrapper">
	...
	<?php echo form_open('/admin/news/update_category?id='.$this->input->get('id')); ?>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group <? if(form_error('n_category_name')) echo 'has-error'; ?>">
						...
						<input type="text" class="form-control" name="n_category_name" id="n_category_name" 
							value="<?php if(set_value('n_category_name') != null) echo set_value('n_category_name'); else echo $category->n_category_name;?>">	
