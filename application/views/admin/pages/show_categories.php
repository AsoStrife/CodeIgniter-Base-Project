...
<div id="page-wrapper">
	...
	<?php echo form_open('/admin/pages/show_categories'); ?>
	<div class="row">
		<div class="col-lg-12">
							...
							<div class="col-md-12">
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<?php foreach ($categories as $category):?>
										<tr>
											<td> <input type="checkbox" name="selected_categories[]" value="<?=$category->p_category_id;?>" /> </td>
								            ...
								            <td> <a href="/admin/pages/update_category?id=<?=$category->p_category_id;?>" class="btn btn-default"> Modifica </a> </td>
										</tr>
									<?php endforeach;?>
								</table>
							</div> <!-- /.col-md-12-->
